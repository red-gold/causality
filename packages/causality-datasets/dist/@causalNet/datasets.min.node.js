(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["@causalNet/datasets"] = factory(require("causal-net.core"), require("causal-net.storage"));
	else
		root["@causalNet/datasets"] = factory(root["causal-net.core"], root["causal-net.storage"]);
...
function (_BaseImgDataset) {
  ...
  function MnistDataset() {
    ...
    _this.storage = new causal_net_storage__WEBPACK_IMPORTED_MODULE_2__["LevelDBStorage"](); // this.preprocessing = new Preprocessing();
  ...
  _createClass(MnistDataset, [{
    ...
    value: function loadDatasetSync() {
      ...
      var datum = F.zip(data, encodedLabels);
      var generator = f.generatorWithIndex(datum);
      this.sampleId = [];
...
function (_BaseFunction) {
  ...
  _createClass(Function, [{
    key: "splitBuffer",
    value: function splitBuffer(data, sampleSize) {
    ...
    key: "makeTrainTestSet",
    value: function makeTrainTestSet(items, splitIndex) {
      var R = this.R;
