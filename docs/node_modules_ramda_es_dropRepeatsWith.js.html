...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/es/dropRepeatsWith.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/es/dropRepeatsWith.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import _curry2 from './internal/_curry2.js';
...
export default dropRepeatsWith;</code></pre>
        </article>
    </section>
