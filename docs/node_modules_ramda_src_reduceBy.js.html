...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/reduceBy.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/reduceBy.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var _curryN = /*#__PURE__*/require('./internal/_curryN');
...
module.exports = reduceBy;</code></pre>
        </article>
    </section>
