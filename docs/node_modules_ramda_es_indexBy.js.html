...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/es/indexBy.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/es/indexBy.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import reduceBy from './reduceBy.js';
...
export default indexBy;</code></pre>
        </article>
    </section>
