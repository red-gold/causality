...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/es/composeK.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/es/composeK.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import chain from './chain.js';
