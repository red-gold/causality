...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/countBy.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/countBy.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var reduceBy = /*#__PURE__*/require('./reduceBy');
...
module.exports = countBy;</code></pre>
        </article>
    </section>
