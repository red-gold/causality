...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/es/init.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/es/init.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import slice from './slice.js';
