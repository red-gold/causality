...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/unnest.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/unnest.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var _identity = /*#__PURE__*/require('./internal/_identity');
...
module.exports = unnest;</code></pre>
        </article>
    </section>
