...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/test.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/test.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var _cloneRegExp = /*#__PURE__*/require('./internal/_cloneRegExp');
