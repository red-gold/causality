...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/groupBy.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/groupBy.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var _checkForMethod = /*#__PURE__*/require('./internal/_checkForMethod');
...
module.exports = groupBy;</code></pre>
        </article>
    </section>
