...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/src/complement.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/src/complement.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var lift = /*#__PURE__*/require('./lift');
...
module.exports = complement;</code></pre>
        </article>
    </section>
