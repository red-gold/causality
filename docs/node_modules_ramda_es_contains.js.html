...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ramda/es/contains.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ramda/es/contains.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import _includes from './internal/_includes.js';
...
export default contains;</code></pre>
        </article>
    </section>
